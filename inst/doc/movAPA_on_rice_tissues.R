...
library(movAPA)
##source('E:\\sys\\code\\R\\movAPA\\movAPA\\R\\R_funclib_movAPA.r')
...
## ----include=FALSE, eval = TRUE-----------------------------------------------
load('/media/bmi/My Passport/scPACext_HC_288cells/movAPA-old/movAPA/vignettes/Oryza_sativa.IRGSP-1.0.42.gff.rda')
